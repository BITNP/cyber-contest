...
def make_exam_json(exam_sql_path, prize_sql_path, problems_sql_path, output_path):
    # Read exam data from exam-2026.sql
    exam = {
        "title": "2026北京理工大学国家网络安全宣传周线上答题",
        "intro": "北京理工大学2026国家网络安全宣传周线上答题，由网络开拓者协会承办。开始答题后将持续计时，若意外退出，可重新进入继续答题。每人有两次答题机会，参加周五网安俱乐部开展的网络安全知识讲座可获得额外两次答题机会。 <br/>请认真填写学号姓名，每次答题提交后即自动抽奖，中奖概率与分数正相关。奖品请于2026年9月22日 - 9月28日 19:00-22:00到网络开拓者协会办公室(北校区北理桥下左数第一个)领取哦~ <br/>一等奖：神秘大奖 1份<br/>二等奖：闪迪64GB U盘 10份<br/>三等奖：USB扩展坞 10份<br/>四等奖：手提电脑包 15份<br/>欢乐奖：树莓娘通行证 110份<br/>网安俱乐部外场活动时空坐标: 2026-09-19（周五）19:00-21:00, 地点: 综A102<br/>PS：网安周线上答题活动持续时间为2026.9.15-9.21。网安外场活动中也可线下参与答题抽奖活动（包括额外抽奖次数）",
        "limit_time": 300,
        "random": 15,
        "limit_number": 2,
        "active": True
...
if __name__ == "__main__":
    ...
    make_exam_json(
        exam_sql_path=os.path.join(ndquiz_dir, "OnlineExam", "db", "exam-2026.sql"),
        prize_sql_path=os.path.join(ndquiz_dir, "OnlineExam", "db", "prize-2026.sql"),
