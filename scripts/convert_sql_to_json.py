...
def make_exam_json(exam_sql_path, prize_sql_path, problems_sql_path, output_path):
    ...
    exam = {
        ...
        "intro": "北京理工大学2026国家网络安全宣传周线上答题，由网络开拓者协会承办。开始答题后将持续计时，若意外退出，可重新进入继续答题。每人有两次答题机会，参加周五网安俱乐部开展的网络安全知识讲座可获得额外两次答题机会。 <br/>请认真填写学号姓名。<br/>网安俱乐部外场活动时空坐标: 2026-09-19（周五）19:00-21:00, 地点: 综A102<br/>PS：网安周线上答题活动持续时间为2026.9.15-9.21。网安外场活动中也可线下参与答题抽奖活动（包括额外抽奖次数）",
        "limit_time": 300,
        "random": 15,
        "limit_number": 2,
        "active": True
